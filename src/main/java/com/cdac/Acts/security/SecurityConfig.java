    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                    ...
                    .requestMatchers("/api/verifier/**").permitAll()  //hasAuthority("VERIFIER")  // Protect verifier routes
                    .requestMatchers("/api/user/**").hasAuthority("USER")
                    .requestMatchers("/api/documents/**").permitAll()//.hasAnyAuthority("USER","VERIFIER","ADMIN")
                    .requestMatchers("/api/files/**").hasAnyAuthority("USER","VERIFIER","ADMIN")
                    .requestMatchers("/api/global/**").permitAll() //.hasAnyAuthority("USER","VERIFIER","ADMIN")
